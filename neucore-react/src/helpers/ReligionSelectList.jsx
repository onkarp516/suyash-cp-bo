...
import { getReligion, createReligion } from "@/services/api_functions";
import {
  Tooltip,
  Modal,
  CloseButton,
...
export default function ReligionSelectList(props) {
  ...
  const getReligionOptions = (setVal = null) => {
    getReligion()
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          if (setVal != null && Opt.length > 0) {
            let religion = getSelectValue(Opt, setVal);
            props.setFieldValue("religionId", religion);
          }
        }
      })
      .catch((error) => {
  ...
  const selecthandleChange = (newValue, actionMeta) => {
    props.setFieldValue("religionId", newValue);
  };
  ...
  return (
    <div>
      <Form.Label htmlFor="religionId" style={{ marginBottom: "0px" }}>
        Religion <span className="redstar">*</span>
        <a
          href=""
          onClick={(e) => {
            e.preventDefault();
      ...
      >
        ...
        <Formik
          ...
          onSubmit={(values, { resetForm, setStatus, setSubmitting }) => {
            ...
            requestData.append("religionName", values.religionName);
            ...
            createReligion(requestData)
              .then((response) => {
                if (response.data.responseStatus === 200) {
                  ...
                  setisLoading(false);
                  getReligionOptions(response.data.response);
                  // setFieldValue();
                } else {
                  setSubmitting(false);
                }
          ...
          render={({
            ...
            <Form autoComplete="off" onSubmit={handleSubmit}>
                  ...
                  <Col md="4">
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        isValid={touched.religionName && !errors.religionName}
              ...
              <Modal.Footer className="p-2">
                ...
                <Button
                  className="mainbtn1 modalcancelbtn cancelbtn formbtn submitbtn"
                  type="button"
                  onClick={() => {
                    onAddModalShow(null);
                  }}
