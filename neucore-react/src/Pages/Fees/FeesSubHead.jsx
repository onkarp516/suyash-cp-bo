...
export default class FeesSubHead extends React.Component {
  constructor(props) {
    super(props);
  ...
  setInitValAndLoadData() {
    ...
    this.setState(
      ...
      () => {
        this.getAllSubFeeHeadslst();
      }
    );
  }

  getAllSubFeeHeadslst = () => {
    getAllSubFeeHeads()
      .then((response) => {
  ...
  getFeeHeadsByBranchlst = (branchId, studentType, feeHeadId = null) => {
    console.log({ branchId, studentType, feeHeadId });
    let reqData = new FormData();

    reqData.append("branchId", authenticationService.currentUserValue.branchId);
      ...
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          this.setState({ opFeesHeadList: Opt }, () => {
            ...
            if (initVal != null && feeHeadId != null) {
              initVal["feeHeadId"] = getSelectValue(Opt, parseInt(feeHeadId));
  ...
  getSubFeeHeadByIdFun = (id) => {
    let { studentTypeOptions, opFeesHeadList, opbranchList } = this.state;
      ...
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          let initVal = {
            ...
            feeHeadId: ob.feeHeadId,
            subFeeHeadName: ob.subFeeHeadName ? ob.subFeeHeadName : "",
          };
          this.setState({ initVal: initVal, opendiv: true }, () => {
            this.getFeeHeadsByBranchlst(
              initVal.branchId.value,
              initVal.studentType.value,
              initVal.feeHeadId
            );
          });
        }
            ...
            <div className="main-div mb-2 m-0">
              ...
              <Formik
                ...
                validationSchema={Yup.object().shape({
                  subFeeHeadName: Yup.string()
                    .trim()
                    .required("sub fee head name  is required"),
                  branchId: Yup.object()
                    .required("Branch is required")
                    .nullable(),
                  feeHeadId: Yup.object()
                    .required("Fee Head is required")
                    .nullable(),
                ...
                onSubmit={(values, { setSubmitting, resetForm }) => {
                  ...
                  requestData.append("feeHeadId", values.feeHeadId.value);
                  requestData.append("studentType", values.studentType.value);
                  requestData.append("subFeeHeadName", values.subFeeHeadName);

                  setSubmitting(true);
                  if (values.id == "") {
                    createFeeSubHead(requestData)
                      .then((response) => {
                        let res = response.data;
                        if (res.responseStatus == 200) {
                          setSubmitting(false);
                      ...
                      <Row className="">
                        <Col md="12" className="mb-2">
                          <Row className="row-inside">
                            ...
                            <Col md="2">
                              <Form.Group className="createnew">
                                ...
                                <Select
                                  ...
                                  value={values.feeHeadId}
                                  invalid={errors.feeHeadId ? true : false}
                                />
                                <span className="text-danger errormsg">
                                  {errors.feeHeadId && errors.feeHeadId}
                                </span>
                              </Form.Group>
                            </Col>
                            ...
                            <Col md="2">
                              <Form.Group>
                                <Form.Label>Sub Fee Head Name</Form.Label>
                                <Form.Control
                                  type="text"
                                  placeholder="Sub Fee Head Name"
                                  name="subFeeHeadName"
                                  id="subFeeHeadName"
                                  onChange={handleChange}
                                  value={values.subFeeHeadName}
                                  isValid={
                                    touched.subFeeHeadName &&
                                    !errors.subFeeHeadName
                                  }
                                  isInvalid={!!errors.subFeeHeadName}
                                />
                                <span className="text-danger errormsg">
                                  {errors.subFeeHeadName}
                                </span>
              ...
              <Col lg={2} md={3} xs={12} className="btn_align mainbtn_create">
                ...
                {!opendiv && (
                  <Button
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      if (isActionExist("sub-head", "create")) {
                            ...
                            <td>
                              ...
                              <a
                                ...
                                onClick={(e) => {
                                  ...
                                  if (isActionExist("sub-head", "edit")) {
                                    this.getSubFeeHeadByIdFun(v.id);
                                  } else {
                                    MyNotifications.fire({
                                      show: true,
                                      icon: "error",
