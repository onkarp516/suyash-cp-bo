...
export default class FeesHead extends React.Component {
  constructor(props) {
    super(props);
  ...
  UpdateFeesHeadWithPosting = (values, isnormalUpdate) => {
    ...
    requestData.append(
      "isReceiptCurrentBranch",
      values.isReceiptCurrentBranch == "current" ? true : false
    );
                ...
                onSubmit={(values, { setSubmitting, resetForm }) => {
                  ...
                  if (values.id == "") {
                    ...
                    MyNotifications.fire({
                      ...
                      icon: "confirm",
                      title: "confirm",
                      msg: "Are you sure want update with Postings click No for Normal Update?",
                      is_button_show: true,
                ...
                {!opendiv && (
                  <Button
                    ...
                    onClick={(e) => {
                      ...
                      if (isActionExist("fee-head", "create")) {
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a
                                ...
                                onClick={(e) => {
                                  e.preventDefault();
                                  if (isActionExist("fee-head", "edit")) {
