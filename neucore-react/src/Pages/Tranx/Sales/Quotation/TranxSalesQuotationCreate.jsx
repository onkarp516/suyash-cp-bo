...
export default class TranxSalesQuotationCreate extends React.Component {
  constructor(props) {
    super(props);
                ...
                <Table size="sm" className="tbl-font ">
                  <tbody>
                    ...
                    >
                      ...
                      <td style={{ width: "6%" }} className="sdisledger">
                        <span> Disc % : </span>
                      </td>
                      <td style={{ width: "6%" }}>
                        <span>
                      ...
                      <td></td>
                      <td style={{ width: "3.5%" }} className="sdisledger">
                        TCS :{" "}
                      </td>
                      <td style={{ width: "5%" }}>
                        <span>
                ...
                {({
                  ...
                  <Form onSubmit={handleSubmit} noValidate>
                    <Row>
                      ...
                      <Col md="8" className="mt-4 btn_align">
                ...
                <Table className="serialnotbl additionachargestbl  table-bordered">
                  ...
                  <tbody>
                    {additionalCharges.map((v, i) => {
                      return (
                        <tr>
                          <td style={{ paddingTop: "7px" }}>{i + 1}</td>
                          <td style={{ width: "75%" }}>
                            <Select
                              className="selectTo"
                              components={{
