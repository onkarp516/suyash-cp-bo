...
export default class TranxSalesQuotationToInvoice extends React.Component {
  constructor(props) {
    super(props);
  ...
  // lstSundryDebitorsClient = () => {
  //   getSundryDebtorsIdUrlClient()
  //     .then((response) => {
  //       // console.log("res", response);
  //       let res = response.data;
  //       if (res.responseStatus == 200) {
        ...
        <div className="dashboardpg institutepg">
          ...
          <Formik
            ...
            onSubmit={(values, { setSubmitting, resetForm }) => {
              ...
              requestData.append("bill_no", invoice_data.sibill_no);
              requestData.append("sales_acc_id", invoice_data.salesAccId.value);
              requestData.append("sales_sr_no", invoice_data.si_sr_no);
              // requestData.append(
              //   'transaction_dt',
              //   moment(invoice_data.transaction_dt).format('yyyy-MM-DD')
              // );
                        ...
                        <Form.Group className="createnew">
                          ...
                          <span className="text-danger errormsg">
                            {errors.clientCodeId}
                                  ...
                                  <Col md="7" className="btn_align mt-2">
                          ...
                          <div className="p-2 supplie-det">
                            <ul>
                              <li>
                                <h6> Invoice Sr. No. </h6>:{" "}
                                <span>
                                  {invoice_data ? invoice_data.si_sr_no : ""}
                                </span>
                              </li>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <li>
