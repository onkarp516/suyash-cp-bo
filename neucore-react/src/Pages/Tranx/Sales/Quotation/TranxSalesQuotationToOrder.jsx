...
export default class TranxSalesQuotationToOrder extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleAdditionalChargesSubmit = (discamtval = -1, type = "") => {
    console.log("handleAdditionalChargesSubmit....");
        ...
        <div className="dashboardpg institutepg">
          ...
          <Formik
            ...
            onSubmit={(values, { setSubmitting, resetForm }) => {
              ...
              // requestData.append(
              //   'sale_quotation_ids',
              //   JSON.stringify(sale_quotation_ids)
              // );
              requestData.append(
                "reference_sq_id",
                          ...
                          <div className="p-2 supplie-det">
                            <ul>
                              <li>
                                <h6>Order Sr. #. </h6>:{" "}
                                <span>
                                  {invoice_data ? invoice_data.so_sr_no : ""}
                                </span>
                              </li>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <li>
