...
export default class TranxSalesOrderEdit extends React.Component {
  constructor(props) {
    super(props);
  ...
  setSalesOrderEditData = () => {
    // console.log('purchaseEditData', this.state.purchaseEditData);
      ...
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          let initInvoiceData = {
            ...
            pur_order_date: new Date(invoice_data.invoice_dt),
            purchase_sr_no: 1,
      ...
      <div className="">
        ...
        >
          <Modal.Header
            closeButton
            closeVariant="white"
            className="pl-2 pr-2 pt-1 pb-1 purchaseinvoicepopu"
          >
            <Modal.Title id="example-custom-modal-styling-title" className="">
              Serial No.
            </Modal.Title>
