...
export default class TranxSalesRetrunCreate extends React.Component {
  constructor(props) {
    super(props);
            ...
            <div className="institutetbl pb-2 pt-0 pl-2 pr-2">
              <Form>
                ...
                {/* <Form.Control
                  ...
                  name="adjustment_bills"
                >
                  <option value="false">Adjustment Bill</option>
                  <option value="true"> Pending Bills</option>
                </Form.Control> */}
                ...
                <Table className="allbill_tbl mb-0 ">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        {' '}
                        <Form.Check type="checkbox" label="02" value="02" />
                      </td>
                      <td>02</td>
                      <td>000.000</td>
                      <td>01-12-21</td>
                    ...
                    <tr>
                      <td>
                        <Form.Group
                          ...
                          className="ml-1 pmt-allbtn"
                        >
                          <Form.Check type="checkbox" label="02" />
                        </Form.Group>
                      </td>
                      <td>03</td>
                      <td>000.000</td>
                    ...
                    <tr>
                      <td>
                        <Form.Group
                          ...
                          className="ml-1 pmt-allbtn"
                        >
                          <Form.Check type="checkbox" label="03" />
                        </Form.Group>
                      </td>
                      <td>04</td>
                      <td>000.000</td>
                    ...
                    <tr>
                      <td>
                        ...
                        <Form.Group
                          ...
                          className="ml-1 pmt-allbtn"
                        >
                          <Form.Check type="checkbox" label="04" />
                        </Form.Group>
                      </td>
                      <td>05</td>
                      <td>000.000</td>
                ...
                <div className="create_ref">
                  <div className="institute-head p-2">
                    <Row>
                      ...
                      <Col md="3" className="">
                        <Form.Group controlId="exampleForm.ControlInput1">
                          <Form.Label>Invoice Amt (Tax)</Form.Label>
                          <Form.Control
                            type="text"
                            placeholder="22"
                            value="000.00"
                      ...
                      <Col md="3" className="">
                        <Form.Group controlId="exampleForm.ControlInput1">
                          <Form.Label>Balance Total Amt</Form.Label>
                          <Form.Control
                            type="text"
                            placeholder="22"
                            value="000.00"
        ...
        >
          ...
          >
            ...
            <CloseButton
              ...
              className="pull-right"
              // onClick={this.handleClose}
              onClick={() => this.createproductmodal(false)}
            />
          </Modal.Header>
