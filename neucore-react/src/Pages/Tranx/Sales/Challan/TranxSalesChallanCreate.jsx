...
export default class TranxSalesChallanCreate extends React.Component {
  constructor(props) {
    super(props);
                            ...
                            <Col md="2">
                              <Form.Group>
                                ...
                                <Form.Control
                                  ...
                                  isValid={touched.bill_no && !errors.scbill_no}
                ...
                <Col md="11">
                  <div className="p-2 supplie-det">
                    <ul>
                      <li>
                        <h6>Challan Sr. #. </h6>:{" "}
                        <span>{invoice_data ? invoice_data.sc_sr_no : ""}</span>
                      </li>
                      <li>
                        <h6>Challan Date </h6>:{" "}
                        <span>
