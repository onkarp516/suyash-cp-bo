...
export default class TranxSalesChallanToInvoice extends React.Component {
  constructor(props) {
    super(props);
  ...
  setBillEditData = () => {
    console.log("Hello Sale Challan!!!!!!!!!!");
    const { invoice_data } = this.state;
    let { selectedCounterSales } = invoice_data;

    let sales_challan_ids = selectedCounterSales.map((v) => {
      return { id: v };
    });
    let reqData = new FormData();
              ...
              createSalesInvoice(requestData)
                .then((response) => {
                  ...
                  if (res.responseStatus == 200) {
                    ...
                    // this.initRow();
                    // setTimeout(() => {
                    //   this.props.history.push('/SalesInvoice');
                    // }, 1200);
