...
export default class TranxSalesInvoiceDetails extends React.Component {
  constructor(props) {
    super(props);
  ...
  lstLedgerVoucherDetails = (edit_data) => {
    ...
    getSaleInvoiceDetails(requestData)
      .then((response) => {
        ...
        <div style={{ overflowX: "hidden" }}>
          <div className="mb-2 p-2 bg-white">
            <Row>
              ...
              <Col md="1">{edit_data && edit_data.sale_serial_number}</Col>
              <Col md="1">
                <Form.Label className="pt-0">
                  Voucher #.
                  <span className="pt-1 pl-1 req_validation">*</span>
              ...
              <Col md="1">{edit_data && edit_data.invoice_no}</Col>
              <Col md="1">
                <Form.Label className="pt-0">
                  Transaction Date :
