...
export default class TranxSalesInvoiceCreate extends React.Component {
  constructor(props) {
    super(props);
      ...
      .then((response) => {
        ...
        if (responseData.responseStatus == 200) {
          ...
          let opt = data.map((v) => {
            ...
            return { label: v.pack_name, value: v.id, ...v, unitOpt };
          });
  ...
  componentDidUpdate() {
    ...
    if (
      ...
      this.get_outstanding_sales_return_amtFun(invoice_data.clientNameId.value);
    }
  }
        ...
        <div className="dashboardpg institutepg">
                  ...
                  <div className="p-2 supplie-det">
                    <ul>
                      ...
                      <li>
                        ...
                        <span>
                          {invoice_data
                            ? moment(invoice_data.transaction_dt).format(
                                "DD-MM-YYYY"
                              )
                            : ""}
                        </span>
                      ...
                      {/* <li>
                                <h6>Ledger Balance </h6>: <span>10000.00</span>
                              </li> */}
          ...
          <Formik
            ...
            onSubmit={(values, { setSubmitting, resetForm }) => {
              ...
              if (outstanding_sales_return_amt > 0) {
          ...
          >
            {({
              ...
              >
                <div className="d-bg i-bg" style={{ height: "85vh" }}>
                  ...
                  <div className="summery pl-2 pr-2">
                    <Row>
                      ...
                      <Col md="2">
                        <ButtonGroup
                          className="pull-right submitbtn mt-4 pt-5"
