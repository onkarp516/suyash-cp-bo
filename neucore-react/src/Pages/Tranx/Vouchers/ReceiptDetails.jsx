...
export default class TranxDebitNote extends Component {
  ...
  render() {
    ...
    const columns = [
      ...
      {
        id: 'customer_name', // database column name
        field: 'customername', // response parameter name
        label: 'Customer Name',
        resizable: true,
      },
      {
      ...
      {
        id: 'closing_Balance', // database column name
        field: 'closingbalance', // response parameter name
