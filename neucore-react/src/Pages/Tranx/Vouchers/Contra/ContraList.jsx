...
import { get_contra_list_by_outlet } from "@/services/api_functions";
import {
  AuthenticationCheck,
  MyDatePicker,
  eventBus,
...
export default class ContraList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      show: false,
    ...
    get_contra_list_by_outlet()
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          this.setState({ getContraTable: res.data });
        }
      })
      .catch((error) => {
  ...
  render() {
    const { opendiv, getContraTable } = this.state;
    return (
      <div className="">
                ...
                <Row>
                  ...
                  <Col md="4" className="mainbtn_create">
                    ...
                    <Button
                      ...
                      onClick={(e) => {
                        e.preventDefault();
                        if (isActionExist("tranx_contra_list", "create")) {
