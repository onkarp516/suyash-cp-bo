    ...
    get_Payment_by_id(formData)
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          this.myRef.current.setFieldValue("narrations", res.narration);
          ...
          console.log("payment_peritculars", payment_peritculars);
          let initRowData = [];
                ...
                update_payments(formData)
                  .then((response) => {
                    ...
                    if (res.responseStatus == 200) {
                      ...
                      //   isNewTab: false,
                      // });
                      eventBus.dispatch("page_change", "voucher_paymentlist");
                    } else {
