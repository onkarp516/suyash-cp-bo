...
export default class TranxPurchaseInvoiceCreate extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="">
        <div className="dashboardpg institutepg"></div>
        <nav>
          {/* <div class="fixed-navbar-default">
            <div class="logoSpace">
              ...
              <a class="btn-home" href="#">
                <span class="glyphicon glyphicon-tag"></span> Home
              </a>
              <a class="btn-home-default" href="#">
                <span class="glyphicon glyphicon-fullscreen"></span> Projetos
              </a>
            </div>
            ...
            <div class="container-buttons">
              <div class="logoSpace">
                ...
                <a class="btn-home-default" href="#">
                  <span class="glyphicon glyphicon-signal"></span> Logout
                </a>
              </div>
            </div>
          </div> */}
        ...
        <div class="site-wrap">
          ...
          <h3>
            This is a{' '}
            <a href="http://www.thatbrightrobot.com" target="_blank">
              Bright Robot
            </a>{' '}
            pen!
          </h3>
          <p>
            We've designed a simple CSS-based solution to the standard "drawer
            menu" on mobile or responsive sites. It requires no jQuery or
            Javascript, so it's light weight. (This one even uses inline SVG for
            the menu icon!)
          </p>
          <p>
            The menu trigger is a checkbox with a label. The use of the tilde
            selector for the open menu ( #trigger:checked ~ .site-wrap ) has
            browser support back to IE7, but the{' '}
            {/* <span style="font-family: Courier New; font-size: .9em; background: #eee;">
              :checked
            </span>{' '} */}
            pseudo-class only goes back to IE9.
          </p>
          <p>Enjoy!</p>
        </div>
        <Modal
          ...
          <Modal.Body className="purchaseumodal p-2 p-invoice-modal ">
            <div className="pmt-select-ledger">
              <Row className="mb-1">
                ...
                <Col md="7" className="outstanding_title">
                  <h6>
                    <b>Outstanding :</b> 30,955.00
                  </h6>
                </Col>
                {/* <Col md="7">
                  <Row>
              ...
              <Table className="mb-2">
                <tr>
                  <th className="p-0 checkboxpadding">
                    <Form.Group controlId="formBasicCheckbox1">
                      <Form.Check type="checkbox" label="Invoice no" />
                    </Form.Group>
                    {/* <span className="pt-2 mt-2">Invoice no.</span> */}
                  </th>
                  <th className="p-0">Invoice Date</th>
                ...
                <tbody>
                  ...
                  <tr className="">
                    ...
                    <td className="p-1" style={{ width: '4%' }}>
                      {' '}
                      <Form.Control
                        style={{
                          textAlign: 'right',
          ...
          <Modal.Body className="purchaseumodal p-2 p-invoice-modal ">
            <div className="pmt-select-ledger">
              <Table className="mb-2">
                ...
                <tbody>
                  <tr className="bgcolor" style={{ background: '#e0e6f7' }}>
