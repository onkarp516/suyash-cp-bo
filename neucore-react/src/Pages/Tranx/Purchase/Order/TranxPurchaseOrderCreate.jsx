...
export default class POOrder extends React.Component {
  ...
  componentDidMount() {
    if (AuthenticationCheck()) {
      ...
      mousetrap.bindGlobal("ctrl+u", this.handleResetForm);
    }
  }
  componentWillUnmount() {
    mousetrap.unbindGlobal("ctrl+u", this.handleResetForm);
  }
  /**
   *
   * @param {*} product
      ...
      <div className="">
                ...
                <div className="p-2 supplie-det">
                  <ul>
                    <li>
                      ...
                      <span>{invoice_data ? invoice_data.po_sr_no : ""}</span>
                    </li>
                    <li>
                      <h6>Order Date </h6>:{" "}
                      <span>
                    ...
                    <li>
                      <h6>Order No. </h6>:{" "}
                      <span>{invoice_data ? invoice_data.po_no : ""}</span>
                    </li>
        ...
        <Formik
          ...
          onSubmit={(values, { setSubmitting, resetForm }) => {
            ...
            requestData.append("pur_order_sr_no", invoice_data.po_sr_no); // generated sr no
            requestData.append("pur_order_no", invoice_data.po_no); // user input
            requestData.append("purchase_id", invoice_data.purchaseId.value);
            requestData.append(
              "pur_order_date",
              moment(invoice_data.po_invoice_dt).format("yyyy-MM-DD")
            );
            requestData.append(
              "supplier_code_id",
            ...
            >
              <div className="row-inside ">
                <Table size="sm" className="tbl-font ">
                  ...
                  <tbody className="tranx_bordertop">
                    {rows.map((v, i) => {
                      return (
                        <TRowComponent
                          i={i}
                    ...
                    >
                      ...
                      <td>
                        <Form.Control
                          ...
                          name="totalqtyH"
                          onChange={handleChange}
                          value={values.total_purchase_discount_amt}
                          readOnly
                          placeholder="000.00"
                        />
                      </td>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        {modalshow &&
                          modalshow.data &&
                          modalshow.data.sundry_debtors_name}
                      </td>
                      <td>
                        {modalshow && modalshow.data && modalshow.data.address}
                      </td>
                      <td>
                        {modalshow && modalshow.data && modalshow.data.mobile}
                      </td>
                    </tr>
                  </tbody>
                </Table>
                ...
                {({
                  ...
                  <Form onSubmit={handleSubmit} noValidate>
                    ...
                    <Row>
                      ...
                      <Col md="12" className="btn_align mt-3">
