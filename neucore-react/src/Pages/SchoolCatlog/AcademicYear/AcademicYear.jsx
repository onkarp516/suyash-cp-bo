...
export default class academicYear extends Component {
  constructor(props) {
    super(props);
    // this.transFormRef = React.createRef();
    this.academicyearFormRef = React.createRef();
    this.state = {
      data: [],
        ...
        if (res.responseStatus == 200) {
          ...
          // if (d.length > 0)
          {
            ...
            this.setState({ opbranchList: Opt }, () => {
              ...
              this.academicyearFormRef.current.setFieldValue(
                "branchId",
                branchId
              );
            });
      ...
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          let initVal = {
            ...
            academicYear: ob.academicYear ? ob.academicYear : "",
          };
  ...
  render() {
    const { opendiv, data, initVal, opbranchList } = this.state;
    return (
      <div className="">
        <Collapse in={opendiv}>
          <div
          ...
          >
            <div className="main-div mb-2 m-0 company-from">
              ...
              <Formik
                ...
                innerRef={this.academicyearFormRef}
                ...
                onSubmit={(values, { setSubmitting, resetForm }) => {
                  ...
                  // requestData.append("academicYear", values.academicYear);
                  setSubmitting(true);
                  if (values.id == "") {
                    createAcademicYear(requestData)
                      .then((response) => {
                        let res = response.data;
                        if (res.responseStatus == 200) {
                          setSubmitting(false);
