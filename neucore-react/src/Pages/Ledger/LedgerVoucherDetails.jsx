...
import { getLedgerVoucherDetails } from "@/services/api_functions";
...
export default class TranxPurchaseInvoiceCreate extends React.Component {
  ...
  lstLedgerVoucherDetails = (edit_data) => {
    ...
    requestData.append("tranx_id", edit_data.transaction_id);
    requestData.append("voucher_id", edit_data.voucher_id);

    console.log("propdata called->", edit_data);
    getLedgerVoucherDetails(requestData)
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          this.setState({
            // isEditDataSet: true,
            edit_data: edit_data,
            lstLedgerVoucherList: res.data && res.data.particular_list,
          });
        ...
        <div style={{ overflowX: "hidden" }}>
          <div className="mb-2 p-2 bg-white">
            <Row>
              ...
              <Col md="1">{edit_data && edit_data.voucher_id}</Col>
              <Col md="1">
                <Form.Label className="pt-0">
                  Voucher #.
                  <span className="pt-1 pl-1 req_validation">*</span>
              ...
              <Col md="1">{edit_data && edit_data.voucher_no}</Col>
              <Col md="1">
                <Form.Label className="pt-0">
                  Transaction Date :
              ...
              <Col md="1">
                {edit_data &&
                  moment(edit_data.invoice_date).format("DD-MM-yyyy")}
              </Col>
            </Row>
          </div>
