...
export default class Bus extends React.Component {
  ...
  deleteBusStop = (id) => {
    ...
    requestData.append("busId", id);

    deleteBusData(requestData)
      .then((response) => {
        let res = response.data;
        if (res.responseStatus == 200) {
          MyNotifications.fire({
            ...
            icon: "success",
            title: "Success",
            msg: "Deleted BusStop Record Succesfully !",
            is_timeout: true,
            delay: 1000,
          });
        }
    ...
    getBusStopById(reqData)
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          let initVal = {
            id: result.id,
            busStopName: result.busStopName,
        ...
        <Collapse in={opendiv}>
          <div id="example-collapse-text" className="common-form-style p-1">
            <div className="main-div mb-2 m-0">
              <h4 className="form-header">Bus TransPort</h4>
              <Formik
                ...
                validationSchema={Yup.object().shape({
                  ...
                  busFee: Yup.string().trim().required("Bus Fee is Required"),
                })}
                      ...
                      <Row>
                        <Col md="12" className="mb-2">
                          ...
                          <Row className="row-inside">
                            <Col md="2">
                              <Form.Group>
                                ...
                                <Form.Control
                                  ...
                                  isValid={
                                    touched.busStopName && !errors.busStopName
                                  }
                                  isInvalid={!!errors.busStopName}
                                />
                            ...
                            <Col md="2">
                              <Form.Group>
                                <Form.Label>BusFee</Form.Label>
                                <Form.Control
                                  type="text"
                                  placeholder="Enter BusFees"
                                  name="busFee"
                                  id="busFee"
                                  onChange={handleChange}
                                  value={values.busFee}
                                  isValid={touched.busFee && !errors.busFee}
                        ...
                        <tr>
                          ...
                          <td>
                            <a
                              ...
                              onClick={(e) => {
                                e.preventDefault();
                                this.getBusStopDetailsById(v.id);
                              }}
                            >
                              <img
                                src={edit_ico}
