...
export default class HSN extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      show: false,
    ...
    getAllHSN()
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          this.setState({ gethsntable: res.responseObject });
        }
      })
      .catch((error) => {
        ...
        <Collapse in={opendiv}>
          <div id="example-collapse-text" className="common-form-style m-2 p-2">
            <div className="main-div mb-2 m-0">
              <h4 className="form-header"> HSN</h4>
              <Formik
