...
export default class SubCaste extends React.Component {
  constructor(props) {
    super(props);
    this.subCasteFormRef = React.createRef();
    this.state = {
      data: [],
      opCasteList: [],
      opReligionList: [],
  ...
  getCasteData = (religionId, initObj = null, sbct = null) => {
          ...
          // if (d.length > 0)
          {
            ...
            this.setState({ opCasteList: Opt }, () => {
              if (initObj != null && Opt.length > 0) {
                ...
                initObj["casteId"] = getSelectValue(Opt, parseInt(sbct));
  ...
  getSubCastsById = (subcasteId) => {
    let reqData = new FormData();
    reqData.append("id", subcasteId);
    getSubCasteById(reqData)
      .then((response) => {
        let res = response.data;
        if (res.responseStatus == 200) {
          ...
          let initVal = {
            id: ob.id,
            religionId: getSelectValue(this.state.opReligionList, ob.religionId)
              ? getSelectValue(this.state.opReligionList, ob.religionId)
              : "",
            casteId: ob.casteId,
            subCasteName: ob.subCasteName ? ob.subCasteName : "",
          };
          this.setState({ initVal: initVal, opendiv: true }, () => {
            this.getCasteData(initVal.religionId.value, initVal, ob.casteId);
          });
  ...
  render() {
    const { opReligionList, opCasteList, data, initVal, opendiv } = this.state;
    return (
      <div className="">
        <Collapse in={opendiv}>
          <div
          ...
          >
            <div className="main-div mb-2 m-0">
              <h4 className="form-header"> Sub Caste</h4>
              <Formik
                innerRef={this.subCasteFormRef}
                            ...
                            <Col md="2">
                              <Form.Group>
                                ...
                                <Form.Control
                                  ...
                                  isValid={
                                    touched.subCasteName && !errors.subCasteName
                                  }
                                  onInput={(e) => {
                                    e.target.value =
