      ...
      <>
        ...
        >
                ...
                <Row className="mt-3 mx-4">
                  <Col lg="5">
                    ...
                    <h5 style={{ fontSize: "30px", fontWeight: "500" }}>
                      G.R.No.:____{studentInfo && studentInfo.grNo}
                      __________________
                    </h5>
                    {/* </Form.Label> */}
                    {/* </Form.Group> */}
                  ...
                  <Col lg="5" className="ms-5">
                    ...
                    <h5 style={{ fontSize: "30px", fontWeight: "500" }}>
                      ...
                      Date:_______
                      {/* {
                        (studentInfo.dob = moment(studentInfo.dob).format(
                          "DD-MMMM-YYYY"
                        ))
                      } */}
                      {dates}
          ...
          >
            ...
            <p>
              {" "}
              bonafide Student of this School Studying in Std. __________
              {studentInfo && studentInfo.standardName}_________Div. _________
              {studentInfo && studentInfo.divisionName}________in the
            </p>
            <p>
              year ______{studentInfo && studentInfo.academicYear}
              _______His/ Her/ Birth Date on the General Register is{" "}
              {(studentInfo.dob = moment(studentInfo.dob).format("DD-MM-YYYY"))}
              {/* {(studentInfo.dob = studentInfo.dob.toString();)} */}
              <span className="ms-3 me-4" style={{ wordSpacing: "1.3cm" }}>
                {" "}
                {/* / /{" "} */}
              </span>
            </p>
            <p>
              ...
              {studentInfo.dob1 != null ? studentInfo.dob1 : ""}
              ______________________________________ and He/ She blongs{" "}
            </p>
            <p>
              {" "}
              to the caste ________{studentInfo && studentInfo.caste}
              _________________ and His/Her place of Birth _________
              {studentInfo && studentInfo.placeofbirth}____________ He/ She/
            </p>
            <p>
              {" "}
