...
import suyash_gurukul_logo from "@/assets/images/suyash_gurukul_logo.png";
...
export default class StudentCopy extends Component {
  constructor() {
    ...
    this.state = {
      ...
      generalConductIP: '',
      progressIP: '',
      dateOfLeavingSchoolIP: '',
      stdStudyingIP: '',
      reasonOfLeavingSchoolIP: '',
      remarksIP: '',
    };
                            ...
                            <Form.Group>
                              ...
                              <Select
                                ...
                                onChange={(v) => {
                                  ...
                                  setFieldValue("studentId", "");
                                  if (v != null) {
                                    setFieldValue("studentRollNo", getSelectValue(optRollno, v.value));
                                    setFieldValue(
                                      "studentId",
                                      v
                                    );
          ...
          <Row>
            ...
            >
              ...
              >
                <img
                  alt="logo"
                  src={suyash_gurukul_logo}
                  style={{ width: "80px", height: "80px", marginTop: "-10px" }}
                />
                SUYASH CENTRAL SCHOOL,SOLAPUR
              </h2>
              ...
              >
                Opp. SRP Camp,Vijapur Road,Solapur-413008
                <br />
                Ph-0217-2744921 (Email:suyashcentralcbse@gmail.com)
                <br />
                Affiliated to CBSE Delhi
              </h3>
              <Table bordered className="lc-tbl">
                <tbody>
                  <tr>
                    <td className="td-style">
                      <span>Affiliation No. :</span>{" "}
                      <b>{studentInfo.affiliationNO}</b>
                    </td>
                    <td className="td-style">
                      School Code : {studentInfo && studentInfo.grNo}
                    </td>
                    <td className="td-style">
                      UDISE No. : {studentInfo && studentInfo.grNo}
                    </td>
                  </tr>
                  <tr>
                    <td className="td-style">
                      Saral ID.<span style={{ marginLeft: "30px" }}> : </span>
              ...
              <Table bordered className="lc-tbl">
                <tbody>
                  <tr>
                    <td className="td-style1" colSpan={2}>
                      Name of the Student :{" "}
                      {studentInfo && studentInfo.studentName}
                    </td>
                    <td className="td-style2">
                  ...
                  <tr>
                    <td className="td-style1" colSpan={2}>
                      Father's Name :{" "}
                      <span>{studentInfo && studentInfo.fatherName}</span>
                    </td>
                    <td className="td-style2">
                      Mother's Name :{" "}
                      <span>{studentInfo && studentInfo.motherName}</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="td-style1" colSpan={2}>
                    ...
                    <td className="td-style2">
                      Mother-tongue :{" "}
                      <span>{studentInfo && studentInfo.motherTongue}</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="td-style1">
                      Religion :{studentInfo && studentInfo.religion}
                    </td>
                    <td className="td-style3">
                      Caste :{studentInfo && studentInfo.caste}
                    </td>
                    <td className="td-style2">
                      sub Caste :{studentInfo && studentInfo.subcaste}
                    </td>
                  </tr>
                  <tr>
                    <td className="td-style" colSpan={3}>
                      Place of Birth :{studentInfo && studentInfo.placeofbirth}
                    </td>
                  </tr>
                  <tr>
                    <td className="td-style" colSpan={3}>
                      ...
                      <br />
                      <br />
                      In Words : {studentInfo && studentInfo.dob1}
                    </td>
                  </tr>
                  <tr>
                    <td className="td-style" colSpan={3}>
                  ...
                  <tr>
                    <td className="td-style1" colSpan={2}>
                      ...
                      {studentInfo &&
                        moment(studentInfo.doa).format("DD-MM-YYYY")}
                    </td>
                    <td className="td-style2">
                      Std. :{studentInfo && studentInfo.standardName}
                    </td>
                  </tr>
                  <tr>
                    <td className="td-style1" colSpan={2}>
                      {/* General Conduct :
                      {studentInfo && studentInfo.generalconduct} */}

                      <div style={{ display: 'flex' }}>
                        General Conduct :
                        <Form.Control type="text" className="hideTextBox" onChange={(e) => {
                          e.preventDefault();
                          this.setState({ generalConductIP: e.target.value })
                        }}
                        ...
                        <span className="showText d-none" style={{ paddingLeft: '3px' }}>
                          {generalConductIP}
                        </span>
                      </div>
                    ...
                    <td className="td-style2">
                      ...
                      <div style={{ display: 'flex' }}>
                        ...
                        <Form.Control type="text" className="hideTextBox" onChange={(e) => {
                          e.preventDefault();
                          this.setState({ progressIP: e.target.value })
                        }}
                  ...
                  <tr>
                    <td className="td-style" colSpan={3}>
                      ...
                      {studentInfo &&
                        moment(studentInfo.dol).format("DD-MM-yyyy")} */}

                      <div style={{ display: 'flex' }}>
                        Date of leaving School :
                        <Form.Control type="text" className="hideTextBox" onChange={(e) => {
                          e.preventDefault();
                          this.setState({ dateOfLeavingSchoolIP: e.target.value })
                        }}
                  ...
                  <tr>
                    <td className="td-style" colSpan={3}>
                      <div style={{ display: 'flex' }}>
                        ...
                        <Form.Control type="text" className="hideTextBox" onChange={(e) => {
                          e.preventDefault();
                          this.setState({ stdStudyingIP: e.target.value })
                        }}
                  ...
                  <tr>
                    <td className="td-style" colSpan={3}>
                      ...
                      {studentInfo && studentInfo.reasonofleavingschool} */}
                      <div style={{ display: 'flex' }}>
                        Reason of leaving School :
                        <Form.Control type="text" className="hideTextBox" onChange={(e) => {
                          e.preventDefault();
                          this.setState({ reasonOfLeavingSchoolIP: e.target.value })
                        }}
                  ...
                  <tr>
                    <td className="td-style" colSpan={3}>
                      <div style={{ display: 'flex' }}>
                        ...
                        <Form.Control type="text" className="hideTextBox" onChange={(e) => {
                          e.preventDefault();
                          this.setState({ remarksIP: e.target.value })
                        }}
                  ...
                  {/* <tr>
                    <td className="td-style" colSpan={3}>
                      Student ID :{studentInfo && studentInfo.studentId}
                    </td>
                  </tr>{" "} */}
                </tbody>
              </Table>
              ...
              >
                (<b>Note:</b> No change in any entry in this certificate shall
                be made except bt the authority issuing any infringement of this
                requirement is liable to involve the imposition of penalty such
                as that of rust)
              </h5>
              <h5
                style={{
              ...
              >
                Date : <span style={{ marginLeft: "50px" }}>/</span>
                <span style={{ marginLeft: "50px" }}>/</span>
              </h5>
              <div style={{ display: 'flex' }}>
                <p style={{ width: '33%', margin: '100px 0 0 0 ', textAlign: 'center' }}>Class Teacher</p>
                <p style={{ width: '33%', margin: '100px 0 0 0 ', textAlign: 'center' }}>Clerk</p>
                <p style={{ width: '33%', margin: '100px 0 0 0 ', textAlign: 'center' }}>Head Master</p>
              </div>
            </Col>
          </Row>
        </div>
