...
export default class Bonafide_offset extends React.Component {
  constructor() {
    super();
      ...
      <>
        ...
        <div id="printDiv">
          <Row className="mx-0">
            ...
            >
              <Row style={{ display: "flex", margin: '20px 15px -30px 15px' }}>
                <Col md={3}>
                  <div
                    style={{
                  ...
                  >
                    <p style={{ marginTop: "50%", marginLeft: "35px" }}>
                      {" "}
                      Photo
                    </p>
                  </div>
                ...
                <Col md={9}>
                  ...
                  >
                    ...
                    <div className="d-flex">
                      ...
                      <p style={{
                        borderBottom: "1px solid", width: ' 130px',
                        marginLeft: '70px',
                        marginTop: '17px' // if value top==0 
                      }}>
                        {/* 8989987987987 */}
                      </p>
                    </div>
              ...
              >
                Kumar / Kumari{" "}
                <p style={{
                  borderBottom: "1px solid", width: '425px',
                  marginLeft: '10px',
                  marginRight: '10px',
                  marginTop: '17px' // if value top==0 
                }}>
                  {/* Pravin Sadanand Pola */}
                </p>
              ...
              >
                ...
                <p style={{
                  borderBottom: "1px solid", width: '90px',
                  marginLeft: '10px',
                  marginRight: '10px',
                  marginTop: '17px' // if value top==0 
                }}>
                ...
                Div.
                <p style={{
                  borderBottom: "1px solid", width: '80px',
                  marginLeft: '10px',
                  marginRight: '10px',
                  marginTop: '17px' // if value top==0 
                }}>
              ...
              >
                Year
                <p style={{
                  borderBottom: "1px solid", width: '115px',
                  marginLeft: '10px',
                  marginRight: '10px',
                  marginTop: '17px' // if value top==0 
                }}>
                ...
                {/* If Text not exist */}
                <span style={{ marginRight: '10px', marginLeft: '30px' }}></span>/<span style={{ marginRight: '30px' }}></span>/<span></span>

                {/* If Text Exist */}
                {/* <span style={{ marginRight: '10px', marginLeft: '10px' }}>31</span>/<span style={{ marginRight: '10px' }}>12</span>/<span>2022</span> */}
              ...
              >
                in words
                <p style={{
                  borderBottom: "1px solid", width: '400px',
                  marginLeft: '10px',
                  marginRight: '10px',
                  marginTop: '17px' // if value top==0 
                }}>
              ...
              >
                to the caste
                <p style={{
                  borderBottom: "1px solid", width: '120px',
                  marginLeft: '10px',
                  marginRight: '10px',
                  marginTop: '17px' // if value top==0 
                }}>  {/* 2022 */}
