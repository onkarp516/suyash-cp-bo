...
export default class StudentCopyOnlyData extends Component {
  constructor(props) {
    super(props);
              ...
              {particularList && particularList.length > 0 ? (
                <>
                  <Col
                    ...
                    style={{ marginLeft: "36px", marginBottom: "15px", marginTop: '14px' }}
                  >
                    <div className="text-center">
                      <h3 className="h3-style" style={{
                        color: 'transparent'
                      }}>STUDENT COPY</h3>
                      <p className="p-style" style={{
                        color: 'transparent'
                      }}>DNYANESHWAR PRATISHTHAN,SOLAPUR</p>
                      <img
                        // src={suyash}
                            ...
                            <Row>
                              ...
                              <Col md={12}>
                                <p className="rec-style">
                                  ...
                                  <span className="ms-2" style={{ paddingLeft: '10px' }}>
                                    {feesPaymentData &&
                        ...
                        <tbody className="tbody-style">
                          ...
                          {particularList != "" &&
                            particularList.map((v) => {
                              return (
                                <tr>
                                  <td className="text-start td-style" style={{ paddingLeft: '20px' }}>
                          ...
                          <tr>
                            <td colSpan={2} className="text-start td-style">
                              <b>
                                ...
                                <span className="word-style" style={{ paddingLeft: '10px' }}>
                  ...
                  <Col
                    lg="4"
                    className="data_body"
                    style={{ paddingLeft: "13.5px", marginBottom: "15px", marginTop: '13px' }}
                  >
                    <div className="text-center">
                      <h3 className="h3-style" style={{
                        color: 'transparent'
                            ...
                            <p className="rec-style" style={{ width: "350px" }}>
                              ...
                              <Col md={12}>
                                <p className="rec-style">
                                  ...
                                  <span className="ms-2" style={{ paddingLeft: '15px' }}>
                                    {feesPaymentData &&
                                      feesPaymentData.standard.toUpperCase()}
                                  </span>
                                </p>
                          ...
                          <tr>
                            <td colSpan={2} className="text-start td-style">
                              <b>
                                ...
                                <span className="word-style" style={{ paddingLeft: '20px' }}>
                                  {feesPaymentData && feesPaymentData.inword}
                                  ONLY
                                </span>
                              </b>
                        ...
                        <tbody className="tbody-style">
                          ...
                          {hostelParticularList.length > 0 &&
                            hostelParticularList.map((v) => {
                              return (
                                <tr>
                                  <td className="text-start td-style" style={{ paddingLeft: '10px' }}>
                        ...
                        <Col>
                          ...
                          >
                            <Row>
                              ...
                              <Col md={12}>
                                <p className="rec-style" style={{ paddingLeft: '15px' }}>
                                  <b>
                                    <span style={{
                                      color: 'transparent'
                                    }}>
                              ...
                              <Col md={12}>
                                <p className="rec-style">
                                  ...
                                  <span className="ms-2" style={{ padding: '5px 0px 0px 10px' }}>
                                    {feesPaymentData &&
                                      feesPaymentData.standard.toUpperCase()}
                                  </span>
                                </p>
                            ...
                            hostelParticularList.map((v) => {
                              return (
                                <tr>
                                  ...
                                  <td className="text-center td-style amt-style" style={{ paddingLeft: '10px' }}>
                                    {numberWithCommasIN(v.paidAmount, true, 2)}
