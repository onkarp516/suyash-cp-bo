            ...
            >
              ...
              <Table bordered className="lc-tbl">
                <tbody>
                  <tr>
                    ...
                    <td className="td-style">
                      GR No. : {studentInfo && studentInfo.grNo}
                    </td>
                  </tr>
                  <tr>
                    <td className="td-style">
                      UDISE No.<span style={{ marginLeft: "15px" }}> : </span>
                  ...
                  <tr>
                    <td className="td-style">
                      Saral ID.<span style={{ marginLeft: "25px" }}> : </span>
                      <b>{studentInfo && studentInfo.udiseNo}</b>
                    </td>
                    <td className="td-style">
                      UID : <span>1260</span>
              ...
              <Table bordered className="lc-tbl">
                <tbody>
                  ...
                  <tr>
                    <td className="td-style1" colSpan={2}>
                      Aadhar No. : {studentInfo && studentInfo.gender}
                    </td>
                    <td className="td-style2">
                  ...
                  <tr>
                    ...
                    <td className="td-style2">Progress :</td>
                  </tr>
                  <tr>
                    <td className="td-style" colSpan={3}>
