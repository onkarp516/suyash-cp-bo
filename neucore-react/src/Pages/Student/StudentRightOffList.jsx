...
export default class StudentRightOffList extends React.Component {
    constructor(props) {
        super(props);
    ...
    getStudentListbyStandards = (
        ...
        getStudentRightOffList(requestData).then((response) => {
            let res = response.data;
            console.log("res", res);
            if (res.responseStatus == 200) {
                let d = res.responseObject;
                                        ...
                                        data.map((v, i) => {
                                            ...
                                            return (
                                                <tr>
                                                    ...
                                                    {/* <td>
                                                        {v.doa != ""
                                                            ? moment(v.doa).format("DD-MM-YYYY")
                                                            : ""}
                                                    </td> */}
