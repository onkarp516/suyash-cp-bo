...
export default class StudentList extends React.Component {
  ...
  componentDidMount() {
    ...
    if (prop_data != "") {
      ...
      console.log("this.state.currentAcdemicYearId", this.searchRef.current);
      // this.getStudentListbyStandards(this.searchRef.current.values.academicYearId.value);
    }
  }
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a
                              href="#."
                              onClick={(e) => {
                                if (isActionExist("student-list", "edit")) {
                                  let propsData = {
                                    id: v.id,
                                    filterData:
                            ...
                            <a
                              ...
                              onClick={(e) => {
                                ...
                                if (isActionExist("student-list", "delete")) {
                                  MyNotifications.fire({
                                    show: true,
                                    icon: "confirm",
                                    title: "confirm",
